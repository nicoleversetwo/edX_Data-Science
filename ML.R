...
##
##  The idea here is to predict sex from height information from publicly
##  available dataset on height
##
...
## maximize F1 score
## the average of specificity and sensitivity is the harmonic average
